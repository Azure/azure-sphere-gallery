...
1. Add your root CA certificate:
   ...
   1. Copy the file into certs/root.pem
       ```
...
1. Add your second root CA certificate:
   ...
   1. Copy the file into certs/new_root.pem
...
1. Add your client certificate:
   ...
   1. Copy the file into certs/cert.pem
...
1. Add your client private key:
   ...
   1. Copy the file into certs/private_key.pem

1. Add your client key password: In `main.rs`, find the following line of code and replace `CLIENT_PRIVATE_KEY_PASSWORD` with the client private key password:

    ```c
    const CLIENT_PRIVATE_KEY_PASSWORD: &str = "client_private_key_password";
    ```

    **Note:** If the client key was created without a password, replace `client_private_key_password` with "".
