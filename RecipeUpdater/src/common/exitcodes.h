...
typedef enum {
    ...
    ExitCode_StoppedHandler_Stopped,
    ExitCode_CheckStatus_SetInterfaceState,
    ExitCode_CheckStatus_GetInterfaceCount,
    ExitCode_CheckStatus_GetInterfaceConnectionStatus,
    ExitCode_ConfigureStaticIp_IpConfigApply,
    ExitCode_StartSntpServer_StartSntp,
    ExitCode_StartDhcpServer_StartDhcp
} ExitCode;
