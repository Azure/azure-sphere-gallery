...
// MT3620 SK: Connect SPI device to interface using either mikroBUS sockets on the board and its corresponding CS pin (A or B)
#define SAMPLE_DRAM_SPI AVNET_MT3620_SK_ISU1_SPI

// MT3620 SPI Chip Select (CS) value "A".
#define SAMPLE_DRAM_CS_A MT3620_SPI_CS_A

// MT3620 SPI Chip Select (CS) value "B". This is not a peripheral identifier, and so has no meaning in an app manifest.
#define SAMPLE_DRAM_CS_B MT3620_SPI_CS_B

// MT3620 SK: Socket 1 DRAM IO3
#define SAMPLE_DRAM_SPI_IO3A AVNET_MT3620_SK_GPIO16

// MT3620 SK: Socket 1 DRAM IO2
#define SAMPLE_DRAM_SPI_IO2A AVNET_MT3620_SK_GPIO0

// MT3620 SK: Socket 2 DRAM IO3
#define SAMPLE_DRAM_SPI_IO3B AVNET_MT3620_SK_GPIO17

// MT3620 SK: Socket 2 DRAM IO2
#define SAMPLE_DRAM_SPI_IO2B AVNET_MT3620_SK_GPIO1
